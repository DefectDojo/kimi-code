...
time. Read, Write, Edit, Grep and Glob now resolve the longest existing prefix of the path
(search roots included) and require that a path which looked in-workspace is still in-workspace once
